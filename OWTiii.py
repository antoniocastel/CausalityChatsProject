...
dataFirstT = pd.read_csv('DataForFirstTreatmentiii.csv', index_col=0)
...
plt.savefig('prop_score_wait30iii.pdf',format='pdf')
...
plt.xlabel('propensity score');
plt.ylabel('number of units');
plt.savefig('prop_score_wait302iii.pdf',format='pdf')
